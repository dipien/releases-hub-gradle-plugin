...
object PullRequestGenerator {
    ...
    fun createBody(upgradeResults: List<UpgradeResult>, projectVersion: String): String {
        ...
        builder.append("---")
        builder.appendln()
        builder.append("This pull request was automatically generated by **[Releases Hub Gradle Plugin v$projectVersion](https://github.com/releaseshub/releases-hub-gradle-plugin)**")
