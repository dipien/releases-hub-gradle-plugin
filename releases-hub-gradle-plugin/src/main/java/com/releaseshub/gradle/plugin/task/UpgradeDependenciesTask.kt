...
open class UpgradeDependenciesTask : AbstractTask() {
	...
	private fun createPullRequestBody(upgradeResults: List<UpgradeResult>): String {
		...
		builder.append("Dependencies upgrades")
		upgradeResults.forEach {
			builder.append(" - ${it.artifact} -> ${it.artifact?.toVersion}")
		}
		builder.append("This pull request was automatically generated by **Releases Hub Gradle Plugin**")
