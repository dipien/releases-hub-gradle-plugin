...
open class UpgradeDependenciesTask : AbstractTask() {
    ...
    companion object {
        private const val PULL_REQUEST_FOOOTER = "This pull request was automatically generated by **[Releases Hub Gradle Plugin](https://github.com/maxirosson/releases-hub-gradle-plugin)**"
    }
    ...
    private fun createPullRequestBody(upgradeResults: List<UpgradeResult>, baseBody: String? = null): String {
        ...
        if (baseBody == null) {
            ...
            builder.append(baseBody.replaceFirst(PULL_REQUEST_FOOOTER + "\n", ""))
        }
        upgradeResults.forEach {
        ...
        builder.appendln()
        builder.appendln(PULL_REQUEST_FOOOTER)
